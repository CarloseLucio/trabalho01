...
#### 9.10	SUBCONSULTAS (Mínimo 3)<br>
		...
		Select * from pessoa where fk_endereco__codigo
		in ( select distinct fk_endereco__codigo
		from pessoa
		where fk_endereco__codigo <>'5555') 

![Alt text](https://github.com/ReconhecimentoFacial/trabalho01/blob/master/imagens/subconsulta1.png?raw=true)

		Select * from bairro_ where fk_cidade_numero_cidade
		in ( select distinct fk_cidade_numero_cidade
		from aluno
		where fk_cidade_numero_cidade <> '0') 

		
![Alt text](https://github.com/ReconhecimentoFacial/trabalho01/blob/master/imagens/subconsulta3.png?raw=true)
