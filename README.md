...
>Como nós somos Alunos do Instituto Federal do Espírito Santo, temos contato todos os dias com o ambiente escolar, e pudemos perceber que há alguns problemas na escola que com nosso conhecimento com programação e bancos de dados poderiamos resolver, um desses que percebemos foi a chamada que o professor faz. Na nossa sala ocorre muito dos alunos chegarem atrasado alguns minutos e os professores acabam perdendo certo tempo da aula esperando todos os alunos chegarem para fazer a chamada, com isso criamos a Relavabor Company que é a nossa empresa que tem o intuito de auxiliar com a tecnologia o ambiente escolar. Pensamos em vários metodos de ajudar nesse problema e chegamos a conclusão que seria um otimo investimento a utilização de reconhecimento facial para fazer a chamada para os professores. Nosso projeto é a instalação de sensores na porta e quando os alunos entrarem na sala já seria reconhecido quem é o aluno, o horario que ele entrou,a aula, entre outros dados.Criaremos também um site que conterá todas as informações captadas pelo sensor e mais certas coisas como notas do alunos,atividades,historico presencial, etc. Pensamos que a educação é o futuro e com a tecnologia sé tende a melhorar.  
